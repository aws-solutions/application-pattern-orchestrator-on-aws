...
*/
import { BasicHttpError } from './common-types';
export default class BlueprintError extends BasicHttpError {
    /**
     ...
     *
     * throw new BlueprintError('some error message', 501, false)
     */
    public constructor(message?: string, statusCode?: number, retryable?: boolean) {
