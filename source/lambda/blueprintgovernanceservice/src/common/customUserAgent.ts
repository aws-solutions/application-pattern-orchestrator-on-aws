...
import { environmentVariables } from './configuration/AppConfiguration';

export const customUserAgentString =
    process.env[environmentVariables.UserAgent] ?? 'AwsSolution/SO0178/v1.0.0';
...
export const awsSdkV3Configuration = {
