...
export class CfnNagServiceRoleDefaultPolicyResourceSuppressionAspect implements IAspect {
    public visit(construct: Construct): void {
        if (construct.node.path.endsWith('/ServiceRole/DefaultPolicy/Resource')) {
            addCfnNagSuppressionMeta(construct as CfnResource, [
                {
                    id: 'W12',
                    reason: 'The policy is generated by CDK.',
                },
            ]);
        }
    }
...
// string ending based resource path matching
...
// Regex based resource path matching
