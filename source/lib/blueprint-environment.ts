...
export const environmentVariables = {
    ...
    APPREGISTRY_UPDATER_QUEUE_URL: 'APPREGISTRY_UPDATER_QUEUE_URL',
    GITHUB_TOKEN_SECRET_ID: 'githubTokenSecretId',
    BLUEPRINT_CODE_BUILD_JOB_PROJECT_NAME: 'BLUEPRINT_CODE_BUILD_JOB_PROJECT_NAME',
    BLUEPRINT_BUCKET_NAME: 'BLUEPRINT_BUCKET_NAME',
    S3_BUCKET_NAME: 'S3_BUCKET_NAME',
    GITHUB_URL: 'GITHUB_URL',
    CODEOWNERS: 'CODEOWNERS',
    GITHUB_ORGANIZATION: 'GITHUB_ORGANIZATION',
    ANONYMOUS_DATA_UUID: 'ANONYMOUS_DATA_UUID',
    SOLUTION_ID: 'SOLUTION_ID',
    SOLUTION_VERSION: 'SOLUTION_VERSION',
    SOLUTION_USER_AGENT: 'SOLUTION_USER_AGENT',
    PATTERN_EMAIL_MAPPING_TABLE_NAME: 'PATTERN_EMAIL_MAPPING_TABLE_NAME',
    LOG_LEVEL: 'LOG_LEVEL',
    PATTERN_REPO_TYPE: 'PATTERN_REPO_TYPE',
};
