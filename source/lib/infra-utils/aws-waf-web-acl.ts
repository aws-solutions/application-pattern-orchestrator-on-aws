...
import { WafScope } from '../blueprint-types';
...
export interface AWSWafWebACLProps {
    ...
    description: string;
    /**
     *  Waf scope: Cloudfront or Regional WAF
     */
    wafScope: WafScope;
    /**
    ...
    customResponseBodies?: Record<
        string,
        IResolvable | CfnWebACL.CustomResponseBodyProperty
    >;
...
export class AWSWafWebACL extends Construct {
    ...
    public constructor(scope: Construct, id: string, props: AWSWafWebACLProps) {
        super(scope, id);
